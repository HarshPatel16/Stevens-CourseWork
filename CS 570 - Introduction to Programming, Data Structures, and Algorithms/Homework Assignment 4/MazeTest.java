/***
 * Assignment : Homework Assigment 4
 * Name: Harsh Patel
 * Course: CS-570
 */
...
public class MazeTest extends JFrame implements GridColors {
    ...
    public void solve() 
    {
        ...
        // ArrayList<ArrayList<PairInt>> found = m.findAllMazePaths(0, 0);
        //     JOptionPane.showMessageDialog(null, found.get(i));    
        
        // ArrayList<PairInt> found = m.findMazePathMin(0, 0);
