const lab1 = require("./lab1");
  ...
  // should output 14
  console.log(lab1.questionOne([5, 3, 10]));  //output 134
  console.log(lab1.questionOne([2, 1, 2]));   //output 9
  console.log(lab1.questionOne([5, 10, 9]));  //output 206  
  console.log(lab1.questionOne([0, 1, 2]));   //output 5  
  console.log(lab1.questionOne([2, 1, 5]));   //output 30
